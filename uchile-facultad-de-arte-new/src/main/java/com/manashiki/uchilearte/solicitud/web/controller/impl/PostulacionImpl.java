...
public class PostulacionImpl {

	private static final Logger objLog = Logger.getLogger(PostulacionImpl.class);
...
//			uchileArte = clienteWsRestUtilidades.crearArchivoSolicitud(requestProductoDTO, ipServer);
	...
	public boolean almacenarSolicitudPostulacionPagoOffline() throws IOException {
		...
		boolean online = false;
		return almacenarSolicitudPostulacion(paginaRedireccion, enviarCorreo, online);
	}
