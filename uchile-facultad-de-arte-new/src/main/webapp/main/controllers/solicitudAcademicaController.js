...
solicitudAcademicaApp.controller('SolicitudAcademicaController', [ '$scope', '$http', '$window', '$sce', '$httpParamSerializerJQLike', 
	...
	$(function(){
        $("#formuploadajax").on("submit", function(e){
            ...
            var url = '/uchile-facultad-de-arte-new/rest/SolicitudAcademicaService/subirArchivo';
            $.ajax({
		        url: url,
		        type: 'POST',
		        dataType : 'json',
	...
	$scope.almacenarSolicitudCertificadoPagoOffline = function(){
        ...
        $http.post('/uchile-facultad-de-arte-new/rest/SolicitudAcademicaService/almacenarSolicitudAcademicaPagoOffline', data, config)
        .then(
        	function (response) {
