...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
		...
		<!-- Global datepicker-->
		<link rel="stylesheet" type="text/css" href="/uchile-facultad-de-arte-new/lib/calendario/css/bootstrap-datetimepicker.min.css">
		<script type="text/javascript" src="/uchile-facultad-de-arte-new/lib/calendario/js/bootstrap-datetimepicker.min.js"></script>
		
		<!-- jQuery Global Controller-->		
		<script type="text/javascript" src="/uchile-facultad-de-arte-new/main/controllers/solicitudPostulacionController.js?version=1.0.1"></script>
...
<body ng-controller="PostulacionController" ng-init="parsearSolicitudPostulacionesJson();" class="body">

	<div class="banner">
		<img src='/uchile-facultad-de-arte-new/administracion-solicitudes/banner_1.jpg' border='0' alt="banner 1" class="bannerTop"/>
	</div>
			  ...
			  <table class="table">
			    ...
			    <tbody>
			        ...
			        <td id="imagen" colspan="4" style="display: none;">
			        	<img ng-src='/uchile-facultad-de-arte-new/assets/img/postulacion/pago_de_inscripcion_plataforma_de_postulacion.jpg' 
	    ...
	    <div class="modal-content modelCargando">
	      <div class="modal-header">
	        <h4 class="modal-title">Enviando la Solicitud de Postulación   
	        	<img ng-src='/uchile-facultad-de-arte-new/administracion-solicitudes/3d-loader.gif' height="35" width="35" />
	        </h4>
	      </div>
	    </div>
	  </div>
