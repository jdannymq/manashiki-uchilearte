package com.manashiki.uchilearte.web.utilidades.funcionalidades;
...
public class AccionesObjetosEstaticos {
	...
	public static SelectItem[] listarDiasNacimiento(){
		SelectItem[] listaDiasNacimiento = new SelectItem[31];
		int ivariableMostar;
		int ivariableValor;
		for(int i=0;i<31;i++){
			ivariableMostar = i+1;
	...
	public static SelectItem[] listarMesesNacimiento(){
		SelectItem[] listaMesesNacimiento = new SelectItem[12];
		listaMesesNacimiento[0] = new SelectItem("1", "Enero");
		listaMesesNacimiento[1] = new SelectItem("2", "Febrero");
		listaMesesNacimiento[2] = new SelectItem("3", "Marzo");
		listaMesesNacimiento[3] = new SelectItem("4", "Abril");
		listaMesesNacimiento[4] = new SelectItem("5", "Mayo");
		listaMesesNacimiento[5] = new SelectItem("6", "Junio");
		listaMesesNacimiento[6] = new SelectItem("7", "Julio");
		listaMesesNacimiento[7] = new SelectItem("8", "Agosto");
		listaMesesNacimiento[8] = new SelectItem("9", "Septiembre");
		listaMesesNacimiento[9] = new SelectItem("10", "Octubre");
		listaMesesNacimiento[10] = new SelectItem("11", "Noviembre");
		listaMesesNacimiento[11] = new SelectItem("12", "Diciembre");
		return listaMesesNacimiento;
	}

	public static SelectItem[] listarAniosNacimiento(){
		SelectItem[] listaAniosNacimiento = new SelectItem[119];
		SelectItem[] retListaAniosNacimiento = new SelectItem[119];
		int base = 1900;
		...
		for(int oo=1; oo<=contador; oo++ ){
			retListaAniosNacimiento[oo-1] = new SelectItem(listaAniosNacimiento[contador-oo].getValue(), listaAniosNacimiento[contador-oo].getLabel());
		}
	...
	public static SelectItem[] listarGeneros(){
		SelectItem[] listaGenero = new SelectItem[2];
		listaGenero[0] = new SelectItem("1", "Masculino");
		listaGenero[1] = new SelectItem("2", "Femenino");
		return listaGenero;
	}
	...
	public static SelectItem[] listarNacionalidades(){
		...
		listaNacionalidades	[0] =	new SelectItem("0","	Afgano/na");
		listaNacionalidades	[1] =	new SelectItem("1","	Albanés/sa");
		listaNacionalidades	[2] =	new SelectItem("2","	Alemán/na");
		listaNacionalidades	[3] =	new SelectItem("3","	Andorrano/na");
		listaNacionalidades	[4] =	new SelectItem("4","	Angoleño/ña");
		listaNacionalidades	[5] =	new SelectItem("5","	Antiguano/na");
		listaNacionalidades	[6] =	new SelectItem("6","	Saudí o saudita");
		listaNacionalidades	[7] =	new SelectItem("7","	Argelino/na");
		listaNacionalidades	[8] =	new SelectItem("8","	Argentino/a");
		listaNacionalidades	[9] =	new SelectItem("9","	Armenio/nia");
		listaNacionalidades	[10] =	new SelectItem("10","	Australiano/na");
		listaNacionalidades	[11] =	new SelectItem("11","	Austríaco/ca");
		listaNacionalidades	[12] =	new SelectItem("12","	Azerbaiyano/na");
		listaNacionalidades	[13] =	new SelectItem("13","	Bahameño/ña");
		listaNacionalidades	[14] =	new SelectItem("14","	Bangladesí	");
		listaNacionalidades	[15] =	new SelectItem("15","	Barbadense");
		listaNacionalidades	[16] =	new SelectItem("16","	Bareiní");
		listaNacionalidades	[17] =	new SelectItem("17","	Belga");
		listaNacionalidades	[18] =	new SelectItem("18","	Beliceño/ña");
		listaNacionalidades	[19] =	new SelectItem("19","	Beninés/sa");
		listaNacionalidades	[20] =	new SelectItem("20","	Bielorruso/sa");
		listaNacionalidades	[21] =	new SelectItem("21","	Birmano/na");
		listaNacionalidades	[22] =	new SelectItem("22","	Boliviano/a");
		listaNacionalidades	[23] =	new SelectItem("23","	Bosnio/nia");
		listaNacionalidades	[24] =	new SelectItem("24","	Botsuano/na");
		listaNacionalidades	[25] =	new SelectItem("25","	Brasileño/a");
		listaNacionalidades	[26] =	new SelectItem("26","	Bruneano/na");
