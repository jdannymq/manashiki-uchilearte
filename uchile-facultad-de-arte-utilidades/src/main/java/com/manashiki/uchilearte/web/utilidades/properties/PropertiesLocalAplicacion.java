...
public class PropertiesLocalAplicacion implements Serializable {
	
	private static final long serialVersionUID = 1L;

	public PropertiesLocalAplicacion(){
		super();
	}
	private static final Logger objLog = LoggerFactory.getLogger(PropertiesLocalAplicacion.class);
	...
	public String getLocalListarProgramaUniversidadConPrecio() {
		...
		String wserver = metProp.getProperty("url.metodo.listar.Programa.Universidad.con.Precio");
	...
	public String getLocalListarProgramaUniversidadPostulacionConPrecio() {
		...
		String wserver = metProp.getProperty("url.metodo.listar.Programa.Universidad.Postulacion.con.Precio");
