...
//
//@ManagedBean(name = "administracionSolicitudCertificadoBean")
//@ViewScoped
//public class AdministracionSolicitudCertificadoBean implements Serializable{
//
//	private static final long serialVersionUID = -5904944276867274488L;
//	private static final Logger objLog = LoggerFactory.getLogger(AdministracionSolicitudCertificadoBean.class);
//	/*********************************************/
...
//	private SolicitudCertificadoDTO verSolicitudCertificadoDTO = new SolicitudCertificadoDTO();
...
//	private List<TipoCertificadoDTO> listaTipoCertificadoDTO;
//	private List<FinalidadCertificadoDTO> listaFinalidadCertificadoDTO;
//	
//	PropertiesAplicacion propertiesAplicacion = new PropertiesAplicacion();
//
//	public AdministracionSolicitudCertificadoBean(){
////		objLog.info("INICIO Constructor - SolicitudCertificadoBean");
//
////		objLog.info("FIN Constructor - SolicitudCertificadoBean");
//	}
//
...
//
//		listarUltimosSolicitudCertificadoDTO();
//		
...
//		
//		setListaTipoCertificadoDTO(retListaTipoCertificadoDTO);
//	}
//
...
//		
//		setListaFinalidadCertificadoDTO(retListaFinalidadCertificadoDTO);
//	}
//
//
...
//	 * no lanza Excepciones.
//	 */
//	public void listarUltimosSolicitudCertificadoDTO(){
////		
...
//		uchileArte = clienteRest.post(requestProductoDTO, propertiesAplicacion.getLocalListarSolicitudCertificadoxEntreFechas());
//		//##################################################
//////		String ipServer = PropertiesAplicacion.getVijnanaServidor();
////		String ipServer = "http://162.243.152.10:8080";
////		ClienteWsRestUtilidades clienteWsRestUtilidades = new ClienteWsRestUtilidades();
////		
////		uchileArte = clienteWsRestUtilidades.listarSolicitudCertificadoxEntreFechas(requestProductoDTO, ipServer);
//		//##################################################
//		
...
//			}
//
//			for(TipoCertificadoDTO tipCertDTO: listaTipoCertificadoDTO){
...
//		}
//
//		setListaSolicitudCertificadoDTO(metListaSolicitudCertificadoDTO);
//
////		objLog.info("FIN - listarProgramasUniversidadDTO "+metListaSolicitudCertificadoDTO.size());
//	}
//	
...
////		objLog.info("INI - mostrarDialog");
//		//1 -- Activo
////		objLog.info("FIN - mostrarDialog");
//		return null;
//	}
//
...
//		SolicitudCertificadoDTO = solicitudCertificadoDTO;
//	}
//
...
//	}
//
//	public SolicitudCertificadoDTO getVerSolicitudCertificadoDTO() {
//		return verSolicitudCertificadoDTO;
//	}
//
//	public void setVerSolicitudCertificadoDTO(SolicitudCertificadoDTO verSolicitudCertificadoDTO) {
//		this.verSolicitudCertificadoDTO = verSolicitudCertificadoDTO;
//	}
//
//}
