...
@ManagedBean(name = "solicitudCertificadoBean")
@ViewScoped
public class SolicitudCertificadoBean implements Serializable{

	private static final long serialVersionUID = 3409917190126496151L;

	private static final Logger objLog = LoggerFactory.getLogger(SolicitudCertificadoBean.class);
	/*********************************************/
	...
	UchileProperties aplicacionProperties = new UchileProperties();
	...
	public SolicitudCertificadoBean(){
	...
	public void listarProgramasUniversidadDTO(){
		...
		//
				uchileArte = clienteRest.post(new RequestProductoDTO(), aplicacionProperties.getLocalListarProgramaUniversidad());
		//##################################################
...
//		uchileArte = clienteWsRestUtilidades.listarProgramaUniversidad(new RequestProductoDTO(), ipServer);
	...
	public void listarTipoCertificadoDTO(){
		...
		UchileArte uchileArte = new UchileArte();
				...
				uchileArte = clienteRest.post(new RequestProductoDTO(), aplicacionProperties.getLocalListarTipoCertificados());
		//##################################################
//		String ipServer = PropertiesAplicacion.getVijnanaServidor();
//		//		String ipServer = "localhost:8080";
//		ClienteWsRestUtilidades clienteWsRestUtilidades = new ClienteWsRestUtilidades();
...
//		uchileArte = clienteWsRestUtilidades.listarTipoCertificados(new RequestProductoDTO(), ipServer);
	...
	public void listarFinalidadCertificadoDTO(){
		...
		uchileArte = clienteRest.post(new RequestProductoDTO(), aplicacionProperties.getLocalListarFinalidadCertificados());
		//##################################################
//		String ipServer = PropertiesAplicacion.getVijnanaServidor();
//		//		String ipServer = "localhost:8080";
//		ClienteWsRestUtilidades clienteWsRestUtilidades = new ClienteWsRestUtilidades();
...
//		uchileArte = clienteWsRestUtilidades.listarFinalidadCertificados(new RequestProductoDTO(), ipServer);
	...
	public void inicializarBotonPago(){
		...
		flujoPagoOnline = Boolean.parseBoolean(aplicacionProperties.getServerFlujoPagoOnlineActivo());

		aplicacionPagoOnline = Boolean.parseBoolean(aplicacionProperties.getLocalSolicitudCertificadoPagoOnlineactivo());

		flujoEnviarCorreo = Boolean.parseBoolean(aplicacionProperties.getServerFlujoCorreoActivo());

		aplicacionEnviarCorreo = Boolean.parseBoolean(aplicacionProperties.getLocalSolicitudCertificadoCorreoActivo());
...
//				objLog.info("A1: creando Solicitud");
				UchileArte uchileArte = clienteRest.post(requestProductoDTO, aplicacionProperties.getLocalCrearSolicitudCertificado());
				//##################################################
//				String ipServer = PropertiesAplicacion.getVijnanaServidor();
//				//		String ipServer = "localhost:8080";
//				ClienteWsRestUtilidades clienteWsRestUtilidades = new ClienteWsRestUtilidades();
...
//				UchileArte uchileArte = clienteWsRestUtilidades.crearSolicitudCertificado(requestProductoDTO, ipServer);
				...
				if(flujoEnviarCorreo==true && aplicacionEnviarCorreo==true ){
					clienteRest.postEmail(requestProductoDTO, "1", "1", key, aplicacionProperties.getLocalEnviarCorreoSolicitud());
//					ClienteRest clienteRest = new ClienteRest();
					clienteRest.postEmail(requestProductoDTO,  aplicacionProperties.getServerIdSolicitudCertificadoAplicacion(), aplicacionProperties.getServerIdSolicitudCertificadoEmailWebmail(), key, aplicacionProperties.getLocalEnviarCorreoSolicitud());
				...
				if(flujoPagoOnline == true && aplicacionPagoOnline==true && online == true){
					String valorNegocioSolicitud= ClienteRestUtilidades.obtenerContenidoRequestByMail(requestProductoDTO, aplicacionProperties.getServerIdSolicitudCertificadoAplicacion(), aplicacionProperties.getServerIdSolicitudCertificadoEmailWebmail());
					...
					clienteRest.post(requestProductoDTO, aplicacionProperties.getLocalCrearNegocioSolicitud());
					//##################################################
